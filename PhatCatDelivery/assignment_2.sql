...
CREATE TABLE `tb_restaurant` (
  `tb_restaurant_id` int(11) NOT NULL,
...
ALTER TABLE `tb_restaurant`
  ADD PRIMARY KEY (`tb_restaurant_id`),
...
--
ALTER TABLE `tb_restaurant`
  MODIFY `tb_restaurant_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_restaurant_manager`
--
ALTER TABLE `tb_restaurant_manager`
