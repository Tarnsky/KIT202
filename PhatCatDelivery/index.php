  ...
  <div class = "order">
    <div class="panel">
      <div class="pricing-plan">
        ...
        <a class="btn btn-outline-light btn-lg" href="#" data-toggle="modal" data-target="#burgerModel" role="button">ORDER</a>
      </div>
      <div class="pricing-plan">
        <img src="img/pizza.jpg" alt="" class="food-img">
        <h2 class="food-header">PizzaLand</h2>
        <p>A slice a day keeps the sad away!</p>
        <a class="btn btn-outline-light btn-lg" href="#" data-toggle="modal" data-target="#pizzaModel" role="button">ORDER</a>
      </div>
      <div class="pricing-plan">
        <img src="img/pasta.jpg" alt="" class="food-img">
        <h2 class="food-header">PastaPalace</h2>
        <p>Pasta la vista baby!</p>
        <a class="btn btn-outline-light btn-lg" href="#" data-toggle="modal" data-target="#pastaModel" role="button">ORDER</a>
      </div>
      <div class="pricing-plan">
        <img src="img/fish-food.png" alt="" class="food-img">
        <h2 class="food-header">Sea you soon</h2>
        <p>It's seafood time!</p>
        <a class="btn btn-outline-light btn-lg" href="#" data-toggle="modal" data-target="#fishModel" role="button">ORDER</a>
      </div>
      <div class="pricing-plan">
        <img src="img/food-villa.jpg" alt="" class="food-img">
        <h2 class="food-header">Food Villa</h2>
        <p>House of delicious food!</p>
        <a class="btn btn-outline-light btn-lg" href="#" data-toggle="modal" data-target="#villaModel" role="button"
        >ORDER</a>
      </div>
    </div>
  </div>
...
<!-- About -->
  ...
  <!-- Order Modal Form Burger Town-->

  <div class="modal fade" id="burgerModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form role = "form" class="burgerForm">
            <table class = "responsive">
              <tr class="form-group">
                <tr class="form-group">
                  <td>Cheese Burger $10</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="cburger" name = "cburger" ></td>
                </tr>
                <tr class="form-group">
                  <td>Coke $5</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="coke" name = "coke" ></td>
                </tr>
                <tr class="form-group">
                  <td>Chips $5</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="chip" name = "chip" ></td>
                </tr>
                <tr class="form-group">
                  <td>Total Price</td>
            </table>
            <button class = "btn btn-danger float-right" type = "submit">Order</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          </form>
        </div>
      </div>
  ...
  <!-- Order Modal Form PizzaLand-->

  <div class="modal fade" id="pizzaModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Order</h5>
        ...
        <div class="modal-body">
          <form role = "form" class="burgerForm">
            <table class = "responsive">
              <tr class="form-group">
                <tr class="form-group">
                  <td>Cheese Pizza $10</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="cpizza" name = "cpizza" ></td>
                </tr>
                <tr class="form-group">
                  <tr class="form-group">
                    <td>Vegi Pizza $10</td>
                    <td>Quantity</td>
                    <td><input  class = "form-control" type="text" id="vpizza" name = "vpizza" ></td>
                  </tr>
                <tr class="form-group">
                  <td>Coke $5</td>
                  <td>Quantity</td>
  ...
  <!-- Order Modal Form PastaPalace-->

  <div class="modal fade" id="pastaModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Order</h5>
        ...
        <div class="modal-body">
          <form role = "form" class="pastaForm">
            <table class = "responsive">
              <tr class="form-group">
                <tr class="form-group">
                  <td>Marinara $10</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="mname" name = "mname" ></td>
                </tr>
                <tr class="form-group">
                  <td>Carbonara $10</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="cname" name = "cname" ></td>
                </tr>
                <tr class="form-group">
                  <td>Coke $5</td>
                  <td>Quantity</td>
                ...
                <tr class="form-group">
                  <td>Garlic Bread $5</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="gbread" name = "gbread" ></td>
                </tr>
                <tr class="form-group">
                  <td>Total Price</td>
            </table>
  ...
  <!-- Order Modal Form Sea you soon-->

  <div class="modal fade" id="fishModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Order</h5>
        ...
        <div class="modal-body">
          <form role = "form" class="fishForm">
            <table class = "responsive">
              <tr class="form-group">
                <tr class="form-group">
                  <td>Fish BUcket $10</td>
                  <td>Quantity</td>
                  <td><input  class = "form-control" type="text" id="cburger" name = "cburger" ></td>
                </tr>
                <tr class="form-group">
  ...
  <!-- Order Modal Form Villa-->

  <div class="modal fade" id="villaModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Order</h5>
        ...
        <div class="modal-body">
          <form role = "form" class="villaForm">
            <table class = "responsive">
              <tr class="form-group">
                <tr class="form-group">
                  <td>Pie $7</td>
